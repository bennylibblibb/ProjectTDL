<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="Lineups.aspx.cs" Inherits="JC_SoccerWeb.Lineups" %> 
                ...
                <table class="admin-tan-border" id="table1" cellSpacing="0" cellPadding="0"
                    ...
                    <TR vAlign="top">
                        ...
                        <TD vAlign="top" class="tan-border02" height="1">
                            <Anthem:panel id="plLineup" runat="server">
                                   ...
                                   <TR valign="top" >
                                    ...
                                    <TR  valign="top">
                                        <TD vAlign="top" align="left" colSpan="5"  >
                                            <anthem:DataGrid id="dgLineup" runat="server" OnSelectedIndexChanged="dgLineup_SelectedIndexChanged" Width="100%"  AlternatingItemStyle-BackColor="#EFEFEF"   AllowPaging="True" AutoGenerateColumns="true"  >
                                              ...
                                              <%--  <Columns>
                                                    <asp:TemplateColumn HeaderText=""   >
                                                        ...
                                                        <ItemTemplate> 
  <asp:LinkButton id="btnSelect"  runat="server"  CommandName="Select" Text=' <%#this.dgLineup.CurrentPageIndex * this.dgLineup.PageSize + Container.ItemIndex + 1%>'> </asp:LinkButton>
                                                          </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="JC GUEST">
                                                       <HeaderStyle Wrap="true" HorizontalAlign="Left"  Width="100px" CssClass="grid-header" VerticalAlign="Middle"></HeaderStyle><ItemStyle CssClass="grid-item"></ItemStyle><ItemTemplate>
                                                        ...
                                                        <HeaderStyle Wrap="false" HorizontalAlign="Left" Width="60px" CssClass="grid-header" VerticalAlign="Middle"></HeaderStyle><ItemStyle CssClass="grid-item"></ItemStyle><ItemTemplate>
                                                        ...
                                                        <EditItemTemplate>  
                                                            ...
                                                            <anthem:Label id="lbDAYCODE" runat="server" Width="60px" Text='<%# DataBinder.Eval(Container, "DataItem.HKJCDAYCODE") %>'></anthem:Label>
                                                        </EditItemTemplate> 
                                                    </asp:TemplateColumn>
