...
<ASP:EDITCOMMANDCOLUMN EditText="Edit" CancelText="Cancel" UpdateText="Update" HeaderText="EDIT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"  ItemStyle-Font-Bold="True" ButtonType="LinkButton">
  ...
  <asp:TemplateColumn HeaderText="Name" Visible ="true" >
                                                    ...
                                                    <%-- <asp:TemplateColumn HeaderText="NAME" Visible ="true" >
                                                      ...
                                                      <asp:TemplateColumn HeaderText="League&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" Visible ="true" >
                                                        <HeaderStyle HorizontalAlign="Left" Width="100px" CssClass="grid-header" VerticalAlign="Middle"></HeaderStyle><ItemStyle CssClass="grid-item" Width="100px"></ItemStyle><ItemTemplate>
                                                            <%--<anthem:Label id="lbSTATUS_NAME" runat="server" Width="70px" Text='<%# DataBinder.Eval(Container, "DataItem.STATUS_NAME") %>'></anthem:Label>--%>
                                                      <anthem:Label id="lbLeague" runat="server" Width="100px" Text='<%# DataBinder.Eval(Container, "DataItem.SHORT_NAME") %>'></anthem:Label>
                                                       <br><%# DataBinder.Eval(Container, "DataItem.CLEAGUE_OUTPUT_NAME") %></ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    <asp:TemplateColumn HeaderText="START DATE"   Visible ="true" >
                                                        <HeaderStyle HorizontalAlign="Left"  Wrap="true" Width="60px"  CssClass="grid-header" VerticalAlign="Middle"></HeaderStyle><ItemStyle CssClass="grid-item" Width="60px" ></ItemStyle><ItemTemplate>
                                                            <anthem:Label id="lbSTART_DATE" runat="server" Width="60px"  Text='<%# DataBinder.Eval(Container, "DataItem.START_DATE") %>'></anthem:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                 ...
                                                 <asp:TemplateColumn HeaderText="DateTime" Visible="true">
                                                        <HeaderStyle HorizontalAlign="Left" Width="60px" CssClass="grid-header" VerticalAlign="Middle"></HeaderStyle><ItemStyle CssClass="grid-item" Width="60px" ></ItemStyle><ItemTemplate>
                                                            <anthem:Label id="lbCTIMESTAMP" runat="server" Width="60px" Text='<%# DataBinder.Eval(Container, "DataItem.CMATCHDATETIME ") %>'></anthem:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
  ...
  <asp:TemplateColumn HeaderText="換主/客" Visible="true">
                                                        <HeaderStyle Wrap="false" HorizontalAlign="Left" Width="50px" CssClass="grid-header" VerticalAlign="Middle"></HeaderStyle><ItemStyle CssClass="grid-item"></ItemStyle><ItemTemplate>
                                                            <anthem:checkbox id="lbBooked" Enabled="false" runat="server" Width="50px" BackColor='<%# DataBinder.Eval(Container, "DataItem.MAPPINGSTATUS") is DBNull ?System.Drawing.Color.Empty : Convert.ToBoolean(DataBinder.Eval(Container, "DataItem.MAPPINGSTATUS")) == true ? System.Drawing.Color.Red:System.Drawing.Color.Empty %>'   checked='<%# DataBinder.Eval(Container, "DataItem.MAPPINGSTATUS") is DBNull? false:DataBinder.Eval(Container, "DataItem.MAPPINGSTATUS") %>'></anthem:checkbox>
                                                        </ItemTemplate>
                                                              <EditItemTemplate>
 ...
 <a href=# onclick="window.open('TeamMapping.aspx?Type=HKJC&id=<%# DataBinder.Eval(Container, "DataItem.ID") %>','','scrollbars=yes, resizable=yes, Width=650,height=280, top=200,left=200')" >																	
                                                     ...
                                                     <asp:TemplateColumn HeaderText="Team Mapping"  Visible="false">
                                                        <HeaderStyle Wrap="true" HorizontalAlign="Left" Width="40px" CssClass="grid-header" VerticalAlign="Middle"></HeaderStyle><ItemStyle CssClass="grid-item"></ItemStyle>
                                                          <ItemTemplate>
                                                          </ItemTemplate>
                                                         </asp:TemplateColumn>  
...
<asp:ButtonColumn Text="Cancel"  CommandName="Delete" ItemStyle-Font-Bold="True">
