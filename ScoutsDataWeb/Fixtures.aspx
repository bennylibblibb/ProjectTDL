...
<%@ Page language="c#" Codebehind="Fixtures.aspx.cs" AutoEventWireup="false" Inherits="JC_SoccerWeb.Fixtures" ValidateRequest="false" %>
                        ...
                        <TD vAlign="top" class="tan-border02" height="1">
                            <Anthem:panel id="plRankDetails" runat="server">
                                <TABLE style="BORDER-COLLAPSE: collapse;  WIDTH:1380px; HEIGHT:600px"
                                    ...
                                    <TR  valign="bottom" >
                                        <TD    align="center"  height="1"    ><anthem:DropDownList ID="dplLeagues" runat="server" AutoCallBack="True" Width="120px" >
                                            <asp:ListItem Selected="True" Value="All">All</asp:ListItem>  </anthem:DropDownList>     </TD>  
                                        <TD   align="left" height="1"   >  <anthem:DropDownList ID="dplTeams" runat="server" AutoCallBack="True" Width="120px" >
                                            <asp:ListItem Selected="True" Value="All">All</asp:ListItem>  </anthem:DropDownList>   </TD>
                                        <TD   align="center" height="1"> 
                                            <anthem:DropDownList ID="dplLeague" runat="server" AutoCallBack="True" Visible="false"   Width="100px" >
                                            <asp:ListItem Selected="True" Value="All">All</asp:ListItem>    </anthem:DropDownList>      
                                        </TD>
                                        <TD   align="left" height="1"> 
                                        <span > <strong>  </strong></span> 
                                      <anthem:TextBox ID="txtFrom" runat="server" onclick="SelectDate(this)" Visible="false"  Width="100px">        </anthem:TextBox>
                                     <span > <strong>  </strong></span>
                                         <anthem:TextBox ID="txtTo" runat="server" onclick="SelectDate(this)" Visible="false"    Width="100px">   </anthem:TextBox>
                                         <anthem:Button ID="btnEdit" runat="server" Text="Get"  Visible="false"     Width="60px" />  
                                        </TD>
                                            ...
                                            <anthem:DataGrid id="dgRankDetails" runat="server" OnSelectedIndexChanged="dgRankDetails_SelectedIndexChanged" Width="100%" AlternatingItemStyle-BackColor="#EFEFEF"   AllowPaging="True" AutoGenerateColumns="False"  >
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="NAME" Visible ="true" >
                                                        <HeaderStyle HorizontalAlign="Left" Width="120px" CssClass="grid-header" VerticalAlign="Middle"></HeaderStyle><ItemStyle CssClass="grid-item" Width="120px"></ItemStyle>
                                                        <ItemTemplate  > 
                                                            <anthem:Label id="lbNAME" runat="server" Width="120px" Visible="false" Text='<%# DataBinder.Eval(Container, "DataItem.NAME") %>'></anthem:Label>
                                                       <%# DataBinder.Eval(Container, "DataItem.NAME") %><br/>
                                                            <%# DataBinder.Eval(Container, "DataItem.cNAME") %>    </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                      <asp:TemplateColumn HeaderText="LEAGUE" Visible ="true" >
                                                        <HeaderStyle HorizontalAlign="Left" Width="60px" CssClass="grid-header" VerticalAlign="Middle"></HeaderStyle><ItemStyle CssClass="grid-item" Width="60px"></ItemStyle><ItemTemplate>
                                                            <anthem:Label id="lbSTATUS_NAME" runat="server" Width="60px" Text='<%# DataBinder.Eval(Container, "DataItem.ALIAS") %>'></anthem:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
...
<ASP:EDITCOMMANDCOLUMN EditText="Edit" CancelText="Cancel" UpdateText="Update" Visible="false"   ItemStyle-Font-Bold="True" ButtonType="LinkButton">
                                                    ...
                                                    </ASP:EDITCOMMANDCOLUMN><asp:ButtonColumn  Visible="false"   Text="Cancel"  CommandName="Delete" ItemStyle-Font-Bold="True">
