...
<table  cellSpacing="0" cellPadding="0"   border="0">
	<tr>
		<td  ><anthem:datalist id="tabs" SelectedItemStyle-CssClass="admin-tab-active"   ItemStyle-CssClass="admin-tab-inactive"
				...
				<ItemTemplate>
					<asp:HyperLink   id="hlMenu" runat="server"   Text='<%# ((TabItem) Container.DataItem).Name %>' Target ='<%# (((TabItem) Container.DataItem).Name=="HKJC"&& tabs.SelectedIndex == 0)
                            ||((TabItem) Container.DataItem).Name=="陣容"
                            ||((TabItem) Container.DataItem).Name=="分析"
                            ||((TabItem) Container.DataItem).Name=="數據"
                            ||((TabItem) Container.DataItem).Name=="近績"
                            ||((TabItem) Container.DataItem).Name=="即場"
                            ||((TabItem) Container.DataItem).Name=="比數詳情"
                          //||((TabItem) Container.DataItem).Name=="發送分析"
                          //||((TabItem) Container.DataItem).Name=="發送近績"
                          ...
                          ||((TabItem) Container.DataItem).Name=="球隊排名"
                            ...
                            ?"_blank":"_self" %>'  NavigateUrl="<%# ((TabItem) Container.DataItem).Path %>"  >
