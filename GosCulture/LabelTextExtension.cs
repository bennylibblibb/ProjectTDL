...
namespace GOSTS.GosCulture
{
    ...
    public class LabelTextExtension : MarkupExtension, INotifyPropertyChanged
    {
         /// <summary>
      ...
      /// </summary>
            ...
            get
            {
                ...
                else
                {
                    if (Key != null)
                    {
                        ...
                        try
                        {
                            strResault = CultureHelper.GetString(Key);
                        }
                        catch(Exception ex)
                        {
                        }
        ...
        public LabelTextExtension(string key)
            : this()
        {
            Key = key;
            CultureHelper.LanguageChangeEvent += new EventHandler<EventArgs>(Language_Event);
        }
        public LabelTextExtension(string key, string DefaultValue)
            : this()
        {
            Key = key;
