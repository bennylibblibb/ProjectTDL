...
<script language="C#" runat="server">
	void Page_Load(Object sender,EventArgs e) {
		OtherSoccerGoalDetailsPK PKInfo = new OtherSoccerGoalDetailsPK((string)Application["SoccerDBConnectionString"]);
	...
	void UpdatePKAction(Object sender,CommandEventArgs e) {
		int iUpdated = 0;
		string sNow;
		OtherSoccerGoalDetailsPK PKSend = new OtherSoccerGoalDetailsPK((string)Application["SoccerDBConnectionString"]);
