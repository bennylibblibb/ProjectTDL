...
(With Replicator) csc /t:library /out:..\bin\OtherSoccerLiveGoalOneOnly.dll /r:..\bin\DBManager.dll;..\bin\Files.dll;..\bin\MessageClient.dll;..\bin\Replicator.dll;..\bin\SportsMessage.dll OtherSoccerLiveGoalOneOnly.cs

Without Replicator (Current production):
csc /t:library /out:..\bin\OtherSoccerLiveGoalOneOnly.dll /r:..\bin\DBManager.dll;..\bin\Files.dll;..\bin\MessageClient.dll;..\bin\SportsMessage.dll OtherSoccerLiveGoalOneOnly.cs
*/
...
[assembly:AssemblyDescription("足球2資訊 -> 現場比數(單場)")]
[assembly:AssemblyProduct("Sports.NET")]
[assembly:AssemblyTitle("Sports.NET DLL")]
[assembly:AssemblyVersion("3.1.*")]
namespace SportsUtil {
	public class OtherSoccerLiveGoalOneOnly {
		...
		public OtherSoccerLiveGoalOneOnly(string Connection) {
		...
		public string GetLiveGoal() {
			...
			//SQLString.Append("select othersoccergoalinfo.match_cnt, othersoccergoalinfo.LEAGUE, othersoccergoalinfo.leaglong, othersoccergoalinfo.status, othersoccergoalinfo.matchdate, othersoccergoalinfo.matchtime, othersoccergoalinfo.field, othersoccergoalinfo.host, othersoccergoalinfo.h_scr, othersoccergoalinfo.guest, othersoccergoalinfo.g_scr, (select STARTTIME from TIMEOFOTHERGAME_INFO where IMATCH_CNT=othersoccergoalinfo.match_cnt) STARTTIME from othersoccergoalinfo, othersoccergoalinfo where othersoccergoalinfo.match_cnt=othersoccergoalinfo.match_cnt and othersoccergoalinfo.match_cnt=");
			SQLString.Append("select othersoccergoalinfo.status, (select STARTTIME from TIMEOFOTHERGAME_INFO where IMATCH_CNT=othersoccergoalinfo.match_cnt) STARTTIME, othersoccergoalinfo.match_cnt, othersoccerinfo.LEAGUE, othersoccerinfo.leaglong, othersoccerinfo.matchdate, othersoccerinfo.matchtime, othersoccerinfo.field, othersoccerinfo.host, othersoccergoalinfo.h_scr, othersoccerinfo.guest, othersoccergoalinfo.g_scr from othersoccerinfo, othersoccergoalinfo where othersoccerinfo.match_cnt=othersoccergoalinfo.match_cnt and othersoccergoalinfo.match_cnt=");
			...
			try {
				...
				if(m_SportsOleReader.Read()) {
					...
					//Time Of Game
					//HTMLString.Append("&nbsp;<a href=\"ModifyTimeOfOtherGame.aspx?matchcnt=" + iMatchCount.ToString() + "\">");
					HTMLString.Append("&nbsp;");
				...
				m_SportsLog.Open();
				m_SportsLog.Write(DateTime.Now.ToString("HH:mm:ss") + " OtherSoccerLiveGoalOneOnly.cs.GetLiveGoal(): " + ex.ToString());
				m_SportsLog.Close();
				HTMLString.Remove(0,HTMLString.Length);
				...
				if(!sMatchCount.Equals("")) {
					try {
						if(sMode.Equals("STA")) {	//Update status period
							sOriginalStatus = m_SportsDBMgr.ExecuteQueryString("select STATUS from othersoccergoalinfo where MATCH_CNT=" + sMatchCount);
							m_SportsDBMgr.Close();
							iTimeActivated = m_SportsDBMgr.ExecuteScalar("select count(IMATCH_CNT) from TIMEOFOTHERGAME_INFO where IMATCH_CNT=" + sMatchCount);
							m_SportsDBMgr.Close();
							if(sStatus.Equals("1")) {	//current status = 上半
								if(sOriginalStatus.Equals("0")) {	//未開 -> 上半
									if(iTimeActivated > 0) {
										m_SportsDBMgr.ExecuteNonQuery("update TIMEOFOTHERGAME_INFO set STARTTIME=CURRENT_TIMESTAMP, CSTATUS='" + sStatus + "' where IMATCH_CNT=" + sMatchCount);
									} else {
										m_SportsDBMgr.ExecuteNonQuery("insert into TIMEOFOTHERGAME_INFO values(" + sMatchCount + ",CURRENT_TIMESTAMP,'" + sStatus + "')");
									}
									m_SportsDBMgr.Close();
								}
						...
						//update live goal table (othersoccergoalinfo)
						SQLString.Remove(0,SQLString.Length);
						SQLString.Append("update othersoccergoalinfo set H_SCR='");
						...
						//Time Of Game
						m_SportsOleReader = m_SportsDBMgr.ExecuteQuery("select STARTTIME from TIMEOFOTHERGAME_INFO where IMATCH_CNT=" + sMatchCount);
						if(m_SportsOleReader.Read()) {
						...
						sBatchJob = DateTime.Now.ToString("yyMMddHHmmss_fffffff") + "." + HttpContext.Current.Session["user_name"].ToString() + "." + arrMsgType[39] + ".ini";
						...
						try {
							...
							try {
								...
								m_SportsLog.Write(DateTime.Now.ToString("HH:mm:ss") + " OtherSoccerLiveGoalOneOnly.cs.UpdateLiveGoals(): Notify (LiveGoal) via MSMQ throws MessageQueueException: " + mqEx.ToString());
								m_SportsLog.Close();
								...
								m_SportsLog.Open();
								m_SportsLog.Write(DateTime.Now.ToString("HH:mm:ss") + " Remoting ERROR: Live Goal");
								m_SportsLog.Write(DateTime.Now.ToString("HH:mm:ss") + " OtherSoccerLiveGoalOneOnly.cs.UpdateLiveGoals(): Notify (LiveGoal) via .NET Remoting throws exception: " + ex.ToString());
								m_SportsLog.Close();
							}
						}	catch(Exception ex) {
							m_SportsLog.FilePath = HttpContext.Current.Application["ErrorFilePath"].ToString();
							m_SportsLog.SetFileName(0,LOGFILESUFFIX);
							m_SportsLog.Open();
							m_SportsLog.Write(DateTime.Now.ToString("HH:mm:ss") + " OtherSoccerLiveGoalOneOnly.cs.UpdateLiveGoals(): Notify (LiveGoal) via MSMQ throws exception: " + ex.ToString());
							m_SportsLog.Close();
						}
...
/*
						...
						try {
							...
							m_SportsLog.SetFileName(0,LOGFILESUFFIX);
							m_SportsLog.Open();
							m_SportsLog.Write(DateTime.Now.ToString("HH:mm:ss") + " OtherSoccerLiveGoalOneOnly.cs.UpdateLiveGoals(): Send gogok message throws exception: " + ex.ToString());
							m_SportsLog.Close();
						}
*/
...
*/
						...
						try {
							...
							try {
								...
								m_SportsLog.Write(DateTime.Now.ToString("HH:mm:ss") + " OtherSoccerLiveGoalOneOnly.cs.UpdateLiveGoals(): Notify (LiveGoal - Mango) via MSMQ throws MessageQueueException: " + mqEx.ToString());
								m_SportsLog.Close();
								...
								m_SportsLog.Open();
								m_SportsLog.Write(DateTime.Now.ToString("HH:mm:ss") + " Remoting ERROR: Live Goal - Mango");
								m_SportsLog.Write(DateTime.Now.ToString("HH:mm:ss") + " OtherSoccerLiveGoalOneOnly.cs.UpdateLiveGoals(): Notify (LiveGoal - Mango) via .NET Remoting throws exception: " + ex.ToString());
								m_SportsLog.Close();
							}
						}	catch(Exception ex) {
							m_SportsLog.FilePath = HttpContext.Current.Application["ErrorFilePath"].ToString();
							m_SportsLog.SetFileName(0,LOGFILESUFFIX);
							m_SportsLog.Open();
							m_SportsLog.Write(DateTime.Now.ToString("HH:mm:ss") + " OtherSoccerLiveGoalOneOnly.cs.UpdateLiveGoals(): Notify (LiveGoal - Mango) via MSMQ throws exception: " + ex.ToString());
							m_SportsLog.Close();
						}
						...
						if(iLiveOdds > 0) {	//update live odds
							...
							try {
								...
								try {
									...
									m_SportsLog.Write(DateTime.Now.ToString("HH:mm:ss") + " OtherSoccerLiveGoalOneOnly.cs.UpdateLiveGoals(): Notify (LiveOdds) via MSMQ throws MessageQueueException: " + mqEx.ToString());
									m_SportsLog.Close();
									...
									m_SportsLog.Open();
									m_SportsLog.Write(DateTime.Now.ToString("HH:mm:ss") + " Remoting ERROR: Live Odds");
									m_SportsLog.Write(DateTime.Now.ToString("HH:mm:ss") + " OtherSoccerLiveGoalOneOnly.cs.UpdateLiveGoals(): Notify (LiveOdds) via .NET Remoting throws exception: " + ex.ToString());
									m_SportsLog.Close();
								}
							}	catch(Exception ex) {
								m_SportsLog.FilePath = HttpContext.Current.Application["ErrorFilePath"].ToString();
								m_SportsLog.SetFileName(0,LOGFILESUFFIX);
								m_SportsLog.Open();
								m_SportsLog.Write(DateTime.Now.ToString("HH:mm:ss") + " OtherSoccerLiveGoalOneOnly.cs.UpdateLiveGoals(): Notify (LiveOdds) via MSMQ throws exception: " + ex.ToString());
								m_SportsLog.Close();
							}
						}
						//end modify
						...
						m_SportsLog.SetFileName(0,LOGFILESUFFIX);
						m_SportsLog.Open();
						m_SportsLog.Write(DateTime.Now.ToString("HH:mm:ss") + " OtherSoccerLiveGoalOneOnly.cs.UpdateLiveGoal(): " + ex.ToString());
						m_SportsLog.Close();
					}
				}
			} else {
...
/*
			...
			m_SportsLog.SetFileName(0,LOGFILESUFFIX);
			m_SportsLog.Open();
			m_SportsLog.Write(DateTime.Now.ToString("HH:mm:ss") + " OtherSoccerLiveGoalOneOnly.cs: Send " + iRecUpd.ToString() + " goal (" + HttpContext.Current.Session["user_name"] + ")");
			m_SportsLog.Close();
*/
			return iRecUpd;
		}
