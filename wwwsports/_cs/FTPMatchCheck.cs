...
csc /t:library /out:..\bin\FTPMatchCheck.dll /r:..\bin\DBManager.dll;..\bin\Files.dll FTPMatchCheck.cs
*/
...
[assembly:AssemblyDescription("FTP 檢查 -> 檢查選擇 -> 足球1賽事")]
[assembly:AssemblyProduct("Sports.NET")]
[assembly:AssemblyTitle("Sports.NET DLL")]
[assembly:AssemblyVersion("1.0.*")]
namespace SportsUtil {
	public class FTPMatchCheck {
		...
		public FTPMatchCheck(string Connection) {
		...
		public string ShowCheck() {
			...
			try {				
				...
				SQLString.Append("select IREPORT_ID, LASTUPDATE, CLEAG_ID, CLEAGNAME, CLEAG_FLAG, IHOST_ID, CHOST_NAME, CHOST_FLAG, IGUEST_ID, CGUEST_NAME, CGUEST_FLAG, CBATCHJOB from MATCH_MAPPING order by IREPORT_ID");
		...
		public int Delete() {
			...
			try {			
				for (iRecDelete=0; iRecDelete<iMustDeleteLen; iRecDelete++) {
					...
					SQLString.Remove(0,SQLString.Length);
					SQLString.Append("delete from MATCH_MAPPING where IREPORT_ID=");
