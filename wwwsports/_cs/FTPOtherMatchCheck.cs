...
csc /t:library /out:..\bin\FTPOtherMatchCheck.dll /r:..\bin\DBManager.dll;..\bin\Files.dll FTPOtherMatchCheck.cs
*/
...
[assembly:AssemblyDescription("FTP 檢查 -> 檢查選擇 -> 足球2賽事")]
[assembly:AssemblyProduct("Sports.NET")]
[assembly:AssemblyTitle("Sports.NET DLL")]
[assembly:AssemblyVersion("1.0.*")]
namespace SportsUtil {
	public class FTPOtherMatchCheck {
		...
		public FTPOtherMatchCheck(string Connection) {
		...
		public string ShowCheck() {
			...
			try {				
				...
				SQLString.Append("select IREPORT_ID, LASTUPDATE, CLEAG_ID, CLEAGNAME, CLEAG_FLAG, IHOST_ID, CHOST_NAME, CHOST_FLAG, IGUEST_ID, CGUEST_NAME, CGUEST_FLAG, CBATCHJOB from OTHERMATCH_MAPPING order by IREPORT_ID");
				...
				while(m_SportsOleReader.Read()) {
					...
					if (sLeagFlag == "1") {
						HTMLString.Append("<td align=\"center\"><a href=\"../soccerschedule/AddSoccerSchedule.aspx?leagID=");
						HTMLString.Append(sLeagID);
						HTMLString.Append("\"><font color=\"blue\">" +sLeagName+ "</font></a></td>");
					} else if (sLeagFlag == "2") {
						HTMLString.Append("<td align=\"center\"><a href=\"LeagueManager_ADD.aspx");
						HTMLString.Append("\"><font color=\"red\">" +sLeagName+ "</font></a></td>");
					} else if (sLeagFlag == "3") {
						HTMLString.Append("<td align=\"center\"><font color=\"green\">" +sLeagName+ "</font></td>");
					} else {
					...
					if (sHostFlag == "2") {
						...
						HTMLString.Append("<td align=\"center\"><font color=\"green\">" +sHostName+ "</font></td>");
					} else {
					...
					} else if (sGuestFlag == "3") {
						HTMLString.Append("<td align=\"center\"><font color=\"green\">" +sGuestName+ "</font></td>");
					} else {
		...
		public int Delete() {
			...
			try {			
				for (iRecDelete=0; iRecDelete<iMustDeleteLen; iRecDelete++) {
					...
					SQLString.Remove(0,SQLString.Length);
					SQLString.Append("delete from OTHERMATCH_MAPPING where IREPORT_ID=");
