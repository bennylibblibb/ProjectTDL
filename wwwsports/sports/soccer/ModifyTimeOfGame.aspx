...
<script language="C#" runat="server">
	void Page_Load(Object sender,EventArgs e) {
		ModifyTimeOfGame game = new ModifyTimeOfGame((string)Application["SoccerDBConnectionString"]);
	...
	void UpdateTime(Object sender,EventArgs e) {
		int iUpdated = 0;
		string sNow;
		ModifyTimeOfGame match = new ModifyTimeOfGame((string)Application["SoccerDBConnectionString"]);
		...
		try {
			...
			Response.Redirect("redirectToLiveGoals.htm");
