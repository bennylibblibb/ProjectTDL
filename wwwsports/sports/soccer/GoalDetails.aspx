...
<script language="C#" runat="server">
	void Page_Load(Object sender,EventArgs e) {
		string strMsg;
		GoalDetails details = new GoalDetails((string)Application["SoccerDBConnectionString"]);
...
function openwindow(matchcnt, oneGoalWinName) {
	...
	oneGoalWindow = window.open('GoalDetailsPK.aspx?matchcnt=' + matchcnt,oneGoalWinName,oneGoalWinFeature);
