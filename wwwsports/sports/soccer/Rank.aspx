...
<script language="C#" runat="server">
	...
	void Page_Load(Object sender,EventArgs e) {
		Rank leagRank = new Rank((string)Application["SoccerDBConnectionString"]);

		try {
			RankInformation.InnerHtml = leagRank.ShowRank();
			sAlias = leagRank.Alias;
			UpdateHistoryMessage((string)Application["retrieveInfoMsg"] + "聯賽排名(" + DateTime.Now.ToString("HH:mm:ss") + ")");
	...
	void SendRank(Object sender,EventArgs e) {
		int iUpdated = 0;
		string sNow;
		Rank updRank = new Rank((string)Application["SoccerDBConnectionString"]);
