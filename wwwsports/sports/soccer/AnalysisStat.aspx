...
<script language="C#" runat="server">
	...
	void Page_Load(Object sender,EventArgs e) {
		AnalysisStat matchStat = new AnalysisStat((string)Application["SoccerDBConnectionString"]);

		try {
			AnalysisStatInformation.InnerHtml = matchStat.GetStat();
			iRecCount = matchStat.NumberOfRecords;
			UpdateHistoryMessage((string)Application["retrieveInfoMsg"] + "賽事數據(" + DateTime.Now.ToString("HH:mm:ss") + ")");
	...
	void onSendMatchStat(Object sender,EventArgs e) {
		int[] iUpdated;
		string sNow;
		AnalysisStat statAnly = new AnalysisStat((string)Application["SoccerDBConnectionString"]);
