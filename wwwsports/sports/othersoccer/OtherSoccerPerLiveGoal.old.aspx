...
<script language="C#" runat="server">
	void Page_Load(Object sender,EventArgs e) {
		OtherSoccerLiveGoalOneOnly oneGoalInfo = new OtherSoccerLiveGoalOneOnly((string)Application["SoccerDBConnectionString"]);
	...
	void OnUpdatePeriod(Object sender,EventArgs e) {
		int iUpdated = 0;
		string sNow;
		OtherSoccerLiveGoalOneOnly oneGoal = new OtherSoccerLiveGoalOneOnly((string)Application["SoccerDBConnectionString"]);
