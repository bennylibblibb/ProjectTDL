...
<script language="C#" runat="server">
	...
	void Page_Load(Object sender,EventArgs e) {
		OtherSoccerAllMatches matchInfo = new OtherSoccerAllMatches((string)Application["SoccerDBConnectionString"]);
	...
	void GetMatchesAction(Object sender,CommandEventArgs e) {
		...
		string sNow;
		string sCmd;
		OtherSoccerAllMatches matchUpd = new OtherSoccerAllMatches((string)Application["SoccerDBConnectionString"]);
...
function ReSort(sortType) {
	parent.content_frame.location.replace('OtherSoccerAllMatchesRetrieval.aspx?sort=' + sortType);
}
...
function ShowHiddenMatches() {
	...
	matchWindow = window.open('OtherSoccerHiddenMatch.aspx?type=odds', 'HiddenMatch' , matchWinFeature);
	matchWindow.focus();
}
</script>
