...
<script language="C#" runat="server">
	...
	void Page_Load(Object sender,EventArgs e) {
		FTPMatchCheck matchCheck = new FTPMatchCheck((string)Application["SoccerDBConnectionString"]);
		try {
			MatchCheckInformation.InnerHtml = matchCheck.ShowCheck();
			iRecCount = matchCheck.NumberOfRecords;
	...
	%>
		...
		<%
			for(iDeleteIndex=0;iDeleteIndex<2;iDeleteIndex++) {
				sDeleteAll = "MustDelete[" + iDeleteIndex.ToString() + "]";
		%>
				MatchCheckForm.<%=sDeleteAll%>.checked = false;
		<%
			}
		%>
		}
...
<body>
	<form id="MatchCheckForm" method="post" runat="server">
		...
		<span id="MatchCheckInformation" runat="server" />
		<tr>
