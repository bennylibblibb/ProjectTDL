...
<script language="C#" runat="server">
	void Page_Load(Object sender,EventArgs e) {
		RegionNew aMatch = new RegionNew((string)Application["SoccerDBConnectionString"]);
	...
	void onAddMatch(Object sender,EventArgs e) {
		int iUpdated = 0;
		string sNow;
		RegionNew addMatch = new RegionNew((string)Application["SoccerDBConnectionString"]);
