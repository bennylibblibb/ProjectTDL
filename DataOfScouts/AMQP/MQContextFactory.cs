...
namespace Ecostar.MQConsumer.Core.Infrastructure
{
  ...
  //  [Export(typeof(IMQContextFactory))]
    public class MQContextFactory : IMQContextFactory
    {
        ...
        public MQContext CreateContext(System.Uri mqUri, Action<string, bool> toLog)
        {
...
#pragma warning restore CS0618 // 'IConnection.AutoClose' is obsolete: 'Please explicitly close connections instead.'
        ...
        /// <returns></returns>
        private static IConnection CreateConnection(System.Uri mqUrl)
        {
        ...
        /// <returns></returns>
        private static string MD5Encrypt(System.Uri str)
        {
            MD5 md5 = new MD5CryptoServiceProvider();
            byte[] result = md5.ComputeHash(System.Text.Encoding.Default.GetBytes(str.ToString ()));
